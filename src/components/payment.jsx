...
class payment extends Component {
 ...
 async  confirmorder1() { 
    ...
    this.state.listData2.order_status="placed";
       this.state.deliver.push(this.state.listData2);
    ...
    console.log(this.state.invoice_number);
        ...
        if(this.state.listData1[i].provider_id==this.state.deliver[i].provider_id){
        axios.put("http://13.58.92.162:3000/provider/" + this.state.deliver[i].provider_id, this.state.listData1[i]).then(response => {
        ...
        for(var i=0;i<this.state.deliver.length;i++){
            ...
            axios.post("http://13.58.92.162:3000/orders", this.state.deliver[i]).then(response => {
                console.log(response);
            }).catch(error => console.log(error)
            )
        }
